...
export interface InventoryShippingFormValue {
  name: string;
  capability: string[];
...
@Component({
  selector: 'app-inventory-shipping-form',
  templateUrl: './inventory-shipping-form.component.html',
  styleUrl: './inventory-shipping-form.component.sass',
  host: {
    'class': 'inventory-shipping-form-host'
  }
})
export class InventoryShippingFormComponent {
  ...
  public readonly formChange = output<InventoryShippingFormValue>();
  ...
  public getFormValue(): InventoryShippingFormValue {
